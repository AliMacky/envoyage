    ...
    return <div>
        <div className="h-screen w-screen flex flex-row">
            ...
            <div className="flex flex-col flex-1 w-full gap-2 p-4">
                ...
                <a href={"/logout"}
                   className="mt-2 flex flex-row gap-2 w-fit items-center justify-center hover:bg-zinc-800 transition ease-in-out duration-300 px-4 py-2 rounded-md bg-zinc-900">
                    Logout
